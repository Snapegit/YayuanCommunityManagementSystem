	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f4f8fb"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-if="type!='info'"  label="处理详情" prop="chulixiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.chulixiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.chulixiangqing" label="处理详情" prop="chulixiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"1000px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.chulixiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='chulixiangqing'){
							this.ruleForm.chulixiangqing = obj[o];
							this.ro.chulixiangqing = true;
							continue;
						}
						if(o=='crossuserid'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.chulixiangqing = this.ruleForm.chulixiangqing.replace(reg,'../../../springbootqd13b6ty/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
