...
<div class="content" :style='{"minHeight":"100vh","padding":"20px 30px 20px 0","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231111/6dd5b058a7d54101b882572ff4a4142a.png) no-repeat center top / cover","display":"block","fontSize":"14px","height":"auto"}'>
	...
	<div :style='{"border":"0px solid #bababa","padding":"0","margin":"10px 0 20px","alignItems":"flex-start","color":"#333","display":"block","justifyContent":"center","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","order":"0"}'>
		...
		<div :style='{"padding":"20px","margin":"0 1% 12px 0","borderColor":"#e7f8f8","alignItems":"flex-end","textAlign":"center","display":"flex","float":"left","justifyContent":"center","minHeight":"168px","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('baoxiuxinxi','首页总数')">
			...
			<div :style='{"margin":"0","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"block","width":"auto","justifyContent":"center"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#fff","borderRadius":"30px","textAlign":"center","background":"#7dc855","lineHeight":"26px","fontSize":"14px","minWidth":"80px","height":"auto"}'>{{baoxiuxinxiCount}}</div>
				<div :style='{"margin":"0","color":"#98a6ad","top":"20px","textAlign":"center","left":"0","width":"100%","lineHeight":"24px","fontSize":"14px","position":"absolute","height":"24px"}'>报修信息总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 1% 12px 0","borderColor":"#e7f8e8","alignItems":"flex-end","textAlign":"center","display":"flex","float":"left","justifyContent":"center","minHeight":"168px","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('tousuxinxi','首页总数')">
			<div :style='{"alignItems":"center","top":"50px","left":"0","background":"none","display":"flex","width":"100%","position":"absolute","justifyContent":"center","height":"auto"}'>
				<span class="icon iconfont icon-tijiaoyanzi" :style='{"color":"#86929e","fontSize":"58px"}'></span>
			</div>
			<div :style='{"margin":"0","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"block","width":"auto","justifyContent":"center"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#fff","borderRadius":"30px","textAlign":"center","background":"#7dc855","lineHeight":"26px","fontSize":"14px","minWidth":"80px","height":"auto"}'>{{tousuxinxiCount}}</div>
				<div :style='{"margin":"0","color":"#98a6ad","top":"20px","textAlign":"center","left":"0","width":"100%","lineHeight":"24px","fontSize":"14px","position":"absolute","height":"24px"}'>投诉信息总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 1% 12px 0","borderColor":"#f8f8e6","alignItems":"flex-end","textAlign":"center","display":"flex","float":"left","justifyContent":"center","minHeight":"168px","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('jiaofeixinxi','首页总数')">
			<div :style='{"alignItems":"center","top":"50px","left":"0","background":"none","display":"flex","width":"100%","position":"absolute","justifyContent":"center","height":"auto"}'>
				<span class="icon iconfont icon-huifu3" :style='{"color":"#86929e","fontSize":"58px"}'></span>
			</div>
			<div :style='{"margin":"0","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"block","width":"auto","justifyContent":"center"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#fff","borderRadius":"30px","textAlign":"center","background":"#fcce54","lineHeight":"26px","fontSize":"14px","minWidth":"80px","height":"auto"}'>{{jiaofeixinxiCount}}</div>
				<div :style='{"margin":"0","color":"#98a6ad","top":"20px","textAlign":"center","left":"0","width":"100%","lineHeight":"24px","fontSize":"14px","position":"absolute","height":"24px"}'>缴费信息总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 0 12px","borderColor":"#f8f3e8","alignItems":"flex-end","textAlign":"center","display":"flex","float":"left","justifyContent":"center","minHeight":"168px","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"20%","position":"relative","borderStyle":"solid"}' v-if="isAuth('sheshiyuyue','首页总数')">
			<div :style='{"alignItems":"center","top":"50px","left":"0","background":"none","display":"flex","width":"100%","position":"absolute","justifyContent":"center","height":"auto"}'>
				<span class="icon iconfont icon-zhangjie8" :style='{"color":"#86929e","fontSize":"58px"}'></span>
			</div>
			<div :style='{"margin":"0","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"block","width":"auto","justifyContent":"center"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#fff","borderRadius":"30px","textAlign":"center","background":"#7dc855","lineHeight":"26px","fontSize":"14px","minWidth":"80px","height":"auto"}'>{{sheshiyuyueCount}}</div>
				<div :style='{"margin":"0","color":"#98a6ad","top":"20px","textAlign":"center","left":"0","width":"100%","lineHeight":"24px","fontSize":"14px","position":"absolute","height":"24px"}'>设施预约总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type5" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		...
		<div id="baoxiuxinxiChart1" class="echarts2" v-if="isAuth('baoxiuxinxi','首页统计')"></div>
		<div id="tousuxinxiChart1" class="echarts3" v-if="isAuth('tousuxinxi','首页统计')"></div>
		<div id="jiaofeixinxiChart1" class="echarts4" v-if="isAuth('jiaofeixinxi','首页统计')"></div>
		<div id="sheshiyuyueChart1" class="echarts5" v-if="isAuth('sheshiyuyue','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		this.gettousuxinxiCount();
		this.tousuxinxiChat1();
		this.getjiaofeixinxiCount();
		this.jiaofeixinxiChat1();
		this.getsheshiyuyueCount();
		this.sheshiyuyueChat1();
	},
	methods:{
		// 词云
		...
		gettousuxinxiCount() {
			this.$http({
				url: `tousuxinxi/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.tousuxinxiCount = data.data
				}
			})
		},
		tousuxinxiChat1() {
        ...
        var tousuxinxiChart1 = echarts.init(document.getElementById("tousuxinxiChart1"),'macarons');
        this.$http({
            url: "tousuxinxi/group/tousuriqi",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].tousuriqi);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].tousuriqi
                    })
                }
                var option = {};
				let titleObj = this.bar.title
				titleObj.text = '每日投诉次数'
                ...
                // 使用刚指定的配置项和数据显示图表。
                tousuxinxiChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    tousuxinxiChart1.resize();
                };
            }
        });
      })
        ...
        var jiaofeixinxiChart1 = echarts.init(document.getElementById("jiaofeixinxiChart1"),'macarons');
        this.$http({
            url: `jiaofeixinxi/value/dengjiriqi/jiaofeijine/月`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
		...
		getsheshiyuyueCount() {
			this.$http({
				url: `sheshiyuyue/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.sheshiyuyueCount = data.data
				}
			})
		},
		sheshiyuyueChat1() {
        ...
        var sheshiyuyueChart1 = echarts.init(document.getElementById("sheshiyuyueChart1"),'macarons');
        this.$http({
            url: "sheshiyuyue/group/sheshimingcheng",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].sheshimingcheng);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].sheshimingcheng
                    })
                }
                var option = {};
				let titleObj = this.line.title
				titleObj.text = '设施预约次数'
                ...
                // 使用刚指定的配置项和数据显示图表。
                sheshiyuyueChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    sheshiyuyueChart1.resize();
                };
            }
        });
      })
