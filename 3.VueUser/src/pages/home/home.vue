...
<div class="home-preview" :style='{"margin":"0 auto","flexWrap":"wrap","flexDirection":"row","background":"url(http://codegen.caihongy.cn/20240117/40df7b0ed9d446dc9e3412e83abd813d.jpg) no-repeat center bottom,#d4eeff","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
	...
	<div id="animate_newsnews" class="news animate__animated" :style='{"padding":"40px 7%","margin":"0 auto","backgroundAttachment":"fixed","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","order":"4"}'>
		...
		<div class="title" :style='{"width":"100%","padding":"0","margin":"0 auto","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240117/e2da3af842f44f9f86c61d0ff295414d.png) no-repeat center center / 35%","height":"60px"}'>
			<span :style='{"fontSize":"26px","lineHeight":"60px","color":"#454545","fontWeight":"600"}'>公告通知</span>
		</div>
...
<!-- 特价商品 -->
<div id="animate_listgonggongsheshi" class="lists animate__animated" :style='{"width":"100%","padding":"30px 7% 40px","margin":"0 auto","position":"relative","background":"none","order":"1"}'>
	...
	<div class="title" :style='{"width":"auto","margin":"0 auto 40px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240117/e2da3af842f44f9f86c61d0ff295414d.png) no-repeat center center / 35%","height":"60px"}'>
	  <span :style='{"padding":"0","color":"#454545","display":"block","fontSize":"26px","lineHeight":"60px","fontWeight":"600","font":"\"宋体\""}'>公共设施展示</span>
	</div>
	...
	<div class="list list3 index-pv1">
		<div class="swiper-container" id="listsgonggongsheshi" :style='{"width":"100%","padding":"0","background":"none","height":"auto"}'>
			<div class="swiper-wrapper">
				<div class="swiper-slide animation-box" :style='{"border":"1px solid #ddd","cursor":"pointer","padding":"0 0 6px","borderRadius":"0px","background":"#fff","fontSize":"0","position":"relative"}' v-for="(item,index) in gonggongsheshiList" :key="index" @click="toDetail('gonggongsheshiDetail', item)">
					<img :name="item.id" :style='{"objectFit":"cover","width":"100%","height":"280px"}' v-if="preHttp(item.sheshitupian)" :src="item.sheshitupian.split(',')[0]" alt="" />
					<img :name="item.id" :style='{"objectFit":"cover","width":"100%","height":"280px"}' v-else :src="baseUrl + (item.sheshitupian?item.sheshitupian.split(',')[0]:'')" alt="" />
					<div class="name line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","background":"none","width":"auto","fontSize":"14px","lineHeight":"32px","textOverflow":"ellipsis"}'>{{item.sheshimingcheng}}</div>
	...
	<div @click="moreBtn('gonggongsheshi')" :style='{"border":"0px solid #eccc19","cursor":"pointer","padding":"0 20px","margin":"0","textAlign":"center","display":"block","right":"7%","top":"80px","borderRadius":"16px","background":"none","width":"auto","lineHeight":"32px","position":"absolute"}'>
		<span :style='{"color":"#3389d7","fontSize":"22px"}'>MORE</span>
		<i :style='{"color":"#3389d7","fontSize":"22px","display":"inline-block"}' class="icon iconfont icon-jiantou25"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_listgonggongsheshi',css:'animate__'},
      ...
      preHttp(str) {
		...
		getList() {
			...
			this.$http.get('gonggongsheshi/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.gonggongsheshiList = res.data.data.list;
					...
					this.$nextTick(() => {
						new Swiper ('#listsgonggongsheshi', options)
					})
